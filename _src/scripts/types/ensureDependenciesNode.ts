...
function ensureDependenciesNode(file: string): Array<cytoscape.CollectionReturnValue> {
  ...
  const [node, edge] = ensureNode({
    id: `${env.zz_scope}/types/${lang}/${pack}/${ver}/dependencies`,
    name: 'dependencies',
    label: 'dependencies',
    details: {},
...
export default ensureDependenciesNode;
