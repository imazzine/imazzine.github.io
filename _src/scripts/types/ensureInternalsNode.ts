...
function ensureInternalsNode(file: string): cytoscape.CollectionReturnValue[] {
  ...
  const [node, edge] = ensureNode({
    id: `${env.zz_scope}/types/${lang}/${pack}/${ver}/internals`,
    name: 'internals',
    label: 'internals',
    details: {},
...
export default ensureInternalsNode;
