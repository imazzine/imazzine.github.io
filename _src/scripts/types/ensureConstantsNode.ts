...
function ensureConstantsNode(file: string): cytoscape.CollectionReturnValue[] {
  ...
  const [node, edge] = ensureNode({
    id: `${env.zz_scope}/types/${lang}/${pack}/${ver}/constants`,
    name: 'constants',
    label: 'constants',
    details: {},
...
export default ensureConstantsNode;
